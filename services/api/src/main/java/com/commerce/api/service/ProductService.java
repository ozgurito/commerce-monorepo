// src/main/java/com/commerce/api/service/ProductService.java
...
public class ProductService {
    ...
    private ProductDto toDto(Product p) {
        return new ProductDto(p.getId(), p.getName(), p.getDescription(), p.getPrice(), p.getStock(), p.getCreatedAt());
    }
}
